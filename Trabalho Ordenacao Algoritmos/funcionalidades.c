    ...
    while (1) { // Laço principal que garante o retorno ao menu
        ...
        if (menuEscolha == 1) { // Roda tudo e gera log
            ...
            for (int i = 0; i < 3; i++) {
                ...
                switch (menuEscolha) {
                    case 1: testarAlgoritmo("Bubble Sort", "Aleatorio", bubbleSort, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Bubble Sort", "Crescente", bubbleSort, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Bubble Sort", "Decrescente", bubbleSort, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 2: testarAlgoritmo("Bubble Sort com Parada", "Aleatorio", bubbleSorteComCriterioDeParada, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Bubble Sort com Parada", "Crescente", bubbleSorteComCriterioDeParada, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Bubble Sort com Parada", "Decrescente", bubbleSorteComCriterioDeParada, vetDecrescente, tamanho_atual, NULL);  
                    break;
                    case 3: testarAlgoritmo("Insertion Sort", "Todos", insertionSort, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Insertion Sort", "Crescente", insertionSort, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Insertion Sort", "Decrescente", insertionSort, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 4: testarAlgoritmo("Insertion Sort Binario", "Aleatorio", insertionSortBinario, vetAleatorio, tamanho_atual, NULL);
                            testarAlgoritmo("Insertion Sort Binario", "Crescente", insertionSortBinario, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Insertion Sort Binario", "Decrescente", insertionSortBinario, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 5: testarAlgoritmo("Selection Sort", "Todos", selectionSort, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Selection Sort", "Crescente", selectionSort, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Selection Sort", "Decrescente", selectionSort, vetDecrescente, tamanho_atual, NULL);
                    break;   
                    case 6: testarAlgoritmo("Merge Sort", "Aleatorio", mergeSort, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Merge Sort", "Crescente", mergeSort, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Merge Sort", "Decrescente", mergeSort, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 7: testarAlgoritmo("Quick Sort (Pivo Central)", "Aleatorio", quickSortCentro, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Quick Sort (Pivo Central)", "Crescente", quickSortCentro, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Quick Sort (Pivo Central)", "Decrescente", quickSortCentro, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 8: testarAlgoritmo("Quick Sort (Pivo no Fim)", "Aleatorio", quickSortFim, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Quick Sort (Pivo no Fim)", "Crescente", quickSortFim, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Quick Sort (Pivo no Fim)", "Decrescente", quickSortFim, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 9: testarAlgoritmo("Quick Sort (Mediana de 3)", "Aleatorio", quickSortMediana, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Quick Sort (Mediana de 3)", "Crescente", quickSortMediana, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Quick Sort (Mediana de 3)", "Decrescente", quickSortMediana, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 10: testarAlgoritmo("Bucket Sort", "Aleatorio", bucketSort, vetAleatorio, tamanho_atual, NULL); 
                            testarAlgoritmo("Bucket Sort", "Crescente", bucketSort, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Bucket Sort", "Decrescente", bucketSort, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 11: testarAlgoritmo("Shell Sort", "Aleatorio", shellSort, vetAleatorio, tamanho_atual, NULL); 
                             testarAlgoritmo("Shell Sort", "Crescente", shellSort, vetCrescente, tamanho_atual, NULL);
                             testarAlgoritmo("Shell Sort", "Decrescente", shellSort, vetDecrescente, tamanho_atual, NULL);
                    break;
                    case 12: testarAlgoritmo("Radix Sort", "Aleatorio", radixSort, vetAleatorio, tamanho_atual, NULL); 
                             testarAlgoritmo("Radix Sort", "Crescente", radixSort, vetCrescente, tamanho_atual, NULL);
                                testarAlgoritmo("Radix Sort", "Decrescente", radixSort, vetDecrescente, tamanho_atual, NULL);   
                    break;
                    case 13: testarAlgoritmo("Heap Sort", "Aleatorio", heapSort, vetAleatorio, tamanho_atual, NULL);
                            testarAlgoritmo("Heap Sort", "Crescente", heapSort, vetCrescente, tamanho_atual, NULL);
                            testarAlgoritmo("Heap Sort", "Decrescente", heapSort, vetDecrescente, tamanho_atual, NULL);
